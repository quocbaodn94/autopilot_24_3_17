...
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile mainWindow.pro
#############################################################################
...
INCPATH       = -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I. -isystem /usr/include/arm-linux-gnueabihf/qt5 -isystem /usr/include/arm-linux-gnueabihf/qt5/QtWidgets -isystem /usr/include/arm-linux-gnueabihf/qt5/QtGui -isystem /usr/include/arm-linux-gnueabihf/qt5/QtCore -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) `pkg-config opencv --libs` -lQt5Widgets -lQt5Gui -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: mainWindow.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile mainWindow.pro
...
dist: 
	@test -d .tmp/mainWindow1.0.0 || mkdir -p .tmp/mainWindow1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/mainWindow1.0.0/ && $(COPY_FILE) --parents image_function.h .tmp/mainWindow1.0.0/ && $(COPY_FILE) --parents main.cpp image_function.cpp .tmp/mainWindow1.0.0/ && (cd `dirname .tmp/mainWindow1.0.0` && $(TAR) mainWindow1.0.0.tar mainWindow1.0.0 && $(COMPRESS) mainWindow1.0.0.tar) && $(MOVE) `dirname .tmp/mainWindow1.0.0`/mainWindow1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mainWindow1.0.0
...
main.o: main.cpp image_function.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

image_function.o: image_function.cpp image_function.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o image_function.o image_function.cpp
